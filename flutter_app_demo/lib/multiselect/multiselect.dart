...
class MultiSelect extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: TownShipSelect(title: 'Flutter Multi Select'),
    );
  }
}

class TownShipSelect extends StatefulWidget {
  TownShipSelect({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _TownShipSelectState createState() => _TownShipSelectState();
}

class _TownShipSelectState extends State<TownShipSelect> {
          ...
          child: Column(
            children: <Widget>[
                ...
                child: Column(
                  children: <Widget>[
                    MultiSelectBottomSheetField(
                      ...
                      searchable: true,
                      buttonText: Text("Favorite Animals 1"),
                      title: Text("Animals"),
                      items: _items,
                      onConfirm: (values) {
              ...
              MultiSelectBottomSheetField<Animal>(
                ...
                maxChildSize: 0.95,
                title: Text("Animals"),
                buttonText: Text("Favorite Animals 2"),
                items: _items,
                searchable: true,
                validator: (values) {
